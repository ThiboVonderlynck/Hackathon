  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        building: {
          a: "hsl(var(--building-a))",
          b: "hsl(var(--building-b))",
          c: "hsl(var(--building-c))",
          d: "hsl(var(--building-d))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      backgroundImage: {
        ...
        'gradient-cyber': 'linear-gradient(135deg, hsl(var(--accent)), hsl(280 70% 50%))',
        'gradient-terminal': 'linear-gradient(180deg, hsl(var(--card)), hsl(var(--background)))',
      },
    },
  },
